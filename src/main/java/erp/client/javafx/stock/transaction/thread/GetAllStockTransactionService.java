...
import erp.client.javafx.stock.transaction.StockTransactionDTO;
...
public class GetAllStockTransactionService extends Service<Page<StockTransactionDTO>> {
    ...
    @Override
    protected Task<Page<StockTransactionDTO>> createTask() {
        return new GetAllStockTransactionTask();
    }

    class GetAllStockTransactionTask extends Task<Page<StockTransactionDTO>> {

        @Override
        protected Page<StockTransactionDTO> call() throws Exception {
            if (sortMap == null) {
                sortMap = new SortMap("stockTransactionId", "desc");
            }
            ...
            ResponseEntity<Page<StockTransactionDTO>> responseEntity = HttpModule.postRequest(getAllStockTransactionUrl, filter, new TypeReference<Page<StockTransactionDTO>>() {
            });
